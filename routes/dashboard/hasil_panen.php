...
$data = mysqli_query($koneksi, "SELECT * FROM komoditas");
?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Daftar Komoditas</li>
          </ol>
          <h6 class="font-weight-bolder text-white mb-0">Daftar Komoditas</h6>
        </nav>
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0 d-flex align-items-center">
              <h6 class="mb-0 me-auto">Data Daftar Komoditas</h6>
              <a href="/dashboard/hasil_panen/create" class="btn btn-sm btn-primary">Tambah Komoditas</a>
            </div>
                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="word-break: break-word;"><?= htmlspecialchars(substr($value["caption"], 0, 60)) ?>...</td>
                      <td class="text-center">Rp<?= number_format((float) $value["harga"]) ?></td>
                      <td class="text-center">
                        <?= $value["foto"] ? '<img width="80px" height="80px" src="data:image/png;base64,' . $value["foto"] . '" alt="Gambar" />' : "Tidak ada foto" ?>
                      </td>
                      <td class="text-center"><?= $value["created_at"] ?></td>
                      <td class="text-center">
                        <a href="/dashboard/hasil_panen/edit?id=<?= $value["id"] ?>" class="btn btn-sm btn-primary mb-1">Edit</a>
                        <a href="/dashboard/hasil_panen/delete?id=<?= $value["id"] ?>" 
