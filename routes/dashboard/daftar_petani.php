...
<body class="g-sidenav-show   bg-gray-100">
  ...
  <main class="main-content position-relative border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Daftar Petani</li>
          </ol>
          <h6 class="font-weight-bolder text-white mb-0">Daftar Petani</h6>
        </nav>
    ...
    <div class="container-fluid py-4">
      ...
      <?php include_once APP . "/components/layout/dashboard/footer.php" ?>
    </div>
  </main>
  <!--   Core JS Files   -->
